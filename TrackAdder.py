...
tracksFolder = r"C:\Users\takashi\Videos\Auto-Synced-Translated-Dubs-main-v2\output" 
...
videoToProcess = r"C:\Users\takashi\Videos\Auto-Synced-Translated-Dubs-main-v2\movie\youtube#12.2.mp4"
...
print(tracksToAddDict)
finalCommand = f'ffmpeg.exe -i "{videoToProcess}" {trackStringsCombined} {mapList} {metadataCombined} -codec copy "{outputFile}"'
